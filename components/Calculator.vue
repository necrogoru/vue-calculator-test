        ...
        <div class="col s12 l6">
          ...
          <div class="col s12 center s-radius">
            ...
            <p class="input-field">
              ...
              <input class="e-range" type="range" min="10" max="20" id="range-interest" ref="range-interest" v-model="calcParams.interest" />
          ...
          <div class="col s12 center s-radius">
            ...
            <p class="input-field">
              ...
              <input class="e-range" type="range" min="1" max="20" id="range-years" ref="range-years" v-model="calcParams.years" />
              <span class="without-style center-align">20</span>
            </p>
            <div class="col center">
...
<style>
  ...
  .select-dropdown select {
    color: rgb(21, 21, 85);
    border: none;
    border-bottom: 1px solid rgb(21, 21, 85);
    transition: background-color 0.4s ease;
    font-size: 1rem;
    font-weight: 200;
    max-width: 100%;
  ...
  .e-range::-webkit-slider-runnable-track {
    width: 100%;
    height: 30px;
    background: linear-gradient(to bottom, #283db8, #283db8) 100% 50%/100% 3px no-repeat transparent;
  }
